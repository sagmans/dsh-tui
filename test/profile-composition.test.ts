...
const EXPECTED_HOST_ROWS = new Map<string, string>([
  ...
  ['tui-input-trigger', '@sagmans/dsh-tui/feature/input-trigger'],
  ['tui-deliverables', '@sagmans/dsh-tui/feature/deliverables'],
  ...
  ['tui-trajectory', '@sagmans/dsh-tui/feature/trajectory'],
