 ...
 * the contrast secondary text depends on. Bright black is the reliable half of
 * the pair and stays inside the 16-color promise, so a terminal remaps it with
 * its own palette either way.
 */
