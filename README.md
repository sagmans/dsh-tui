...
| that turn, then a click on one of those rows | that call's argument unfolds in full across continuation rows at the same indent, while its neighbours and the card stay as they were |
